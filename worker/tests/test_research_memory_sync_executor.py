    ...
    class FakeAPI:
        ...
        async def register_research_memory(self, request):
            ...
            return ResearchMemoryRegistrationResponse(
                ...
                unchanged=False,
                canonical_ingestion_job_id="11111111-1111-4111-8111-111111111111",
                canonical_object_ids=["22222222-2222-4222-8222-222222222222"],
                corpus_sync_run_id="33333333-3333-4333-8333-333333333333",
            )
