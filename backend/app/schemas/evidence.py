...
class RunPayload(StrictModel):
    ...
    market_model_bundle_digest: str | None = Field(default=None, pattern=_DIGEST)
    representation_contract_digest: str | None = Field(default=None, pattern=_DIGEST)
    search_plan_digest: str | None = Field(default=None, pattern=_DIGEST)
