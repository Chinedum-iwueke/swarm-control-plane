...
class ExecutionSafetySchemaRegistry(Base):
    __tablename__ = "execution_safety_schema_registry"
    __table_args__ = (
        UniqueConstraint("name", "version", name="uq_execution_safety_schema_name_version"),
    )
