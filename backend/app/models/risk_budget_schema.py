...
class RiskBudgetSchemaRegistry(Base):
    __tablename__ = "risk_budget_schema_registry"
    __table_args__ = (UniqueConstraint("name", "version", name="uq_risk_budget_schema_name_version"),)
