...
class PortfolioCapacitySchemaRegistry(Base):
    __tablename__ = "portfolio_capacity_schema_registry"
    __table_args__ = (
        UniqueConstraint("name", "version", name="uq_portfolio_capacity_schema_name_version"),
    )
