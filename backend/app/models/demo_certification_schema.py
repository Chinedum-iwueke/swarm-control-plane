...
class DemoCertificationSchemaRegistry(Base):
    __tablename__ = "demo_certification_schema_registry"
    __table_args__ = (
        UniqueConstraint("name", "version", name="uq_demo_certification_schema_name_version"),
    )
