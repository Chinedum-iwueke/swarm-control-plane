...
class ExecutionEventSchemaRegistry(Base):
    __tablename__ = "execution_event_schema_registry"
    __table_args__ = (
        UniqueConstraint("name", "version", name="uq_execution_event_schema_name_version"),
    )
